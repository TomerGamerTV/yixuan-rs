...
async fn fetch_player_data(
    ...
    let avatar_fut = db.fetch_model_data(uid);
    let item_fut = db.fetch_model_data(uid);
    let quest_fut = db.fetch_model_data(uid);
    let archive_fut = db.fetch_model_data(uid);
    let hollow_fut = db.fetch_model_data(uid);
    let abyss_fut = db.fetch_model_data(uid);
    let buddy_fut = db.fetch_model_data(uid);
    let misc_fut = db.fetch_model_data(uid);
    let main_city_fut = db.fetch_model_data(uid);
    let scene_fut = db.fetch_model_data(uid);
    let gacha_fut = db.fetch_model_data(uid);
    let map_fut = db.fetch_model_data(uid);
    let big_scene_fut = db.fetch_model_data(uid);
